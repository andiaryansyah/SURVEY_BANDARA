...
const Sidebar1 = () => {
  ...
  return (
    ...
    >
      <RiArrowLeftSLine
        size={20}
        className={`absolute cursor-pointer rounded-full bg-white -right-3 top-9 w-7 border-2 border-[#182A68] h-7 w-7 ${
          !open && "rotate-180"
        }`}
      ...
      <div className="flex gap-x-4 items-center">
        ...
        />
        <h1
          className={`text-white font-extrabold tracking-wider origin-left font-medium text-xl duration-300 ${
            !open && "scale-0"
          }`}
        >
          SULTAN BANTILAN
